...
<body>
    ...
    <main>
        <section class="products-header">
            <h2>Nos Coffrets</h2>
            <p>Une sélection unique de produits bio pour le visage, le corps et les cheveux, soigneusement assemblés pour vous offrir une expérience sensorielle inoubliable. Que ce soit pour vous faire plaisir ou pour offrir un cadeau original, vous trouverez forcément le coffret qui vous correspond.</p>
