...
<div class="h-full px-3 py-4 overflow-y-auto bg-gray-200 dark:bg-gray-800">
  ...
  <img src="../images/logo111.jpeg" alt="Logo Floraison" class="w-16 h-16 rounded-full border-2 border-pink-200 shadow-lg">
  <h2 class="text-pink-600 font-bold text-2xl tracking-wide">Floraison</h2>
</div>
   </div>
   <ul class="space-y-2 font-medium">
       <li>
         ...
         <li>
            <a href="listOrders.php" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
...
<li>
  <a href="deconnnexion.php" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
  
    <svg class="shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" 
         xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
      <path d="M16.59 7.41a1 1 0 0 0-1.42 1.42L17.17 11H9a1 1 0 0 0 0 2h8.17l-2 2a1 1 0 0 0 1.42 1.42l3.71-3.71a1 1 0 0 0 0-1.42l-3.71-3.71ZM5 4a1 1 0 0 0-1 1v14a1 1 0 0 0 2 0V5a1 1 0 0 0-1-1Z"/>
    </svg>
